...
class Form_EditMember extends Caclass_Form{
    ...
    public function init() {
     ...
     //   ->setRequired(true)
        ...
        */
        ...
        $this->addElements(array($name,$lname,$sex,$dob,$tel,$live,$city,
        		$height,$weight,$ethic,$rel,$drink,$smoke,$mar,$child,$pay,
        		$job,$country,$edu,$eng,$chinese,$hobby,
        		$sx,$star,$title,$content,$obj,$chkcode,$submit));
	 }
	  ...
	  function __toString() 	{
		...
		'<span class="c3txt required">生肖:</span>'.$this->getElement("sx")->__toString().
		'<span class="c3txt required">星座:</span>'.$this->getElement("star")->__toString().
		'</td></tr>';
